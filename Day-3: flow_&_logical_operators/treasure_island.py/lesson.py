...
choice1 = input('As you navigate down the path you come to a fork, would you like to go right or left? Type either "Right" or "Left". ').lower()
...
if choice1 == "left":
    ...
    if choice2 == "wait":
        ...
        if choice3 == "red":
            ...
            print("You entered a door that doesnt exist. Game over.")
    else:
